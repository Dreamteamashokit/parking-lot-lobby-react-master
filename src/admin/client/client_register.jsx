...
class ClientRegisterPage extends React.Component {
  ...
  getTimeZone() {
    try {
      ...
      const timeZoneArray = [];
      Object.values(timezones).forEach((val) => {
  ...
  handleChange = async (event) => {
    try {
      ...
      const { user, errors, calendly_prefill } = this.state;
      ...
      switch (name) {
        ...
        case "email":
          ...
          if (!checkEmail) {
            ...
            errors.email = false;
            calendly_prefill.email = value;
            console.log("\n calendly_prefill.email:", calendly_prefill.email);
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    ...
    try {
      if (
        nextProps.hasOwnProperty("registerError") &&
        nextProps.registerError &&
        nextProps.hasOwnProperty("registering") &&
        ...
        <div className="steps-wrapper">
          <div className="inner-container">
            <div className="contbx-holder">
              <div className="txbx-holder admin-client-holder">
                <div className="form-holder">
                  <form className="form" action="" method="post">
                    <div className="row">
                      ...
                      <div className="form-group col-md-6">
                        ...
                        <input
                          ...
                          placeholder="set location number for ex: 2"
                          onChange={(e) => this.handleChange(e)}
                        />
                      </div>
                    </div>
                    <div className="row">
                      <div className="form-group col-md-6">
                        <label htmlFor="email-lable">
                          Enter Primary Email Address : {user.email}
                        </label>
                        <input
                          type="email"
                          name="email"
                      ...
                      <div className="form-group col-md-6">
                        ...
                        <span className="iconbx">
                          {" "}
                          <img
                            onClick={(e) => this.changePasswordType(e)}
                            src={
                              passwordType === "password"
                                ? showPasswordSVG
                                : passwordSVG
                    ...
                    <div className="row">
                      <div className="form-group privacy-check col-md-12">
                        <label className="check-container">
                          <input
                            type="checkbox"
                            value={user.agree}
                            name="agree"
                            onChange={(e) => this.handleAgreeCheck(e)}
                            className={
                              errors.agree
                                ? "form-control error-box"
                                : "form-control"
                          ...
                          <span
                            className={
                              errors.agree ? "checkmark error-box" : "checkmark"
                            }
                          ></span>
                          <span className="tx">
                            Yes!I would like to be notified of updates,
                            additional offers, and Other information from PLL.
                          </span>
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="row">
                      <div className="form-group upload-group col-md-6">
                        <div className="drop-zone">
                          <div className="content">
                            <label
                              className="button drag_file-holder"
                              htmlFor="file-name"
                            >
                              {logoImage ? (
                                <div className="select-img-content">
                                  <img
                                    id="cancel-target"
                                    src={cancelSVG}
                                    onClick={this.resetSelectedImage}
                                  />
                                  <img
                                    id="target"
                                    src={logoImage}
                                    onClick={this.updateImageOnClickImage}
                                  />
                                </div>
                              ) : (
                                <div className="drag-contbx">
                                  ...
                                  <p className="btmdesp">
                                    Customize your free PLL signage by adding
                                    your company logo to the{" "}
                                    <a href="#">free signage.</a>{" "}
                                  </p>
                                </div>
                              )}
                              <input
                      ...
                      {user.email && (
                        <div className="form-group col-md-6">
                          <InlineWidget
                            url={calendly_url}
                            prefill={calendly_prefill}
                            pageSettings={calendly_setting}
                            styles={calendly_style}
                          />
                      ...
                      {(!user.email || user.email == "") && (
                        <div className="col-md-12">
                          <p id="calendly-submit-message">
                            Please Provide email for Schedule calendly meeting.
                          </p>
                        </div>
                      )}
                      {user.email && !isCalendlySubmited && (
                        <div className="col-md-12">
                          <p id="calendly-submit-message">
                            Please schedule calendly meeting. Before submit your
                            form{" "}
                          </p>
                        </div>
                      )}
                    ...
                    <div className="row">
                      <div className="agree_terms-contbx col-md-12">
                        <div className="agreebtn-holder">
                          <button
                            type="button"
                            name="button"
                            className="btn cancel"
                            onClick={(e) => this.handleSteps(e)}
                            disabled={registering || !isCalendlySubmited}
                          >
                            {" "}
                            AGREE &amp; CONTINUE{" "}
                          </button>
...
function mapStateToProps(state) {
  const { registering, registerError } = state.adminClientlist;
  return { registering, registerError };
}

const actionCreators = {
  register: adminActions.clientRegister,
};

export default connect(mapStateToProps, actionCreators)(ClientRegisterPage);
